...
class CraftTestController {
    ...
    def save(CraftTest craftTestInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'craftTest.label', default: 'CraftTest'), craftTestInstance.id])
    ...
    def update(CraftTest craftTestInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'CraftTest.label', default: 'CraftTest'), craftTestInstance.id])
                redirect craftTestInstance
            }
    ...
    def delete(CraftTest craftTestInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'CraftTest.label', default: 'CraftTest'), craftTestInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'craftTest.label', default: 'CraftTest'), params.id])
                redirect action: "index", method: "GET"
            }
